...
public class UncaughtExceptionHandler implements Thread.UncaughtExceptionHandler {
    ...
    private UncaughtExceptionHandler(Context context, boolean chained) {
    ...
    static UncaughtExceptionHandler inContext(Context context) {
        return new UncaughtExceptionHandler(context, true);
    }

    static UncaughtExceptionHandler reportOnlyHandler(Context context) {
        return new UncaughtExceptionHandler(context, false);
    }
